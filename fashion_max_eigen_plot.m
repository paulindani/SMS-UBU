...
res=load("C:\counterfactuals-main\max_eigen_fashion.mat");
%figure, histogram(res.max_eig_arr(1:4,1),4)
num_runs=48;

figure, histogram(res.max_eig_arr(1:num_runs,1),10)
title('Norm of Hessian (random weights)')
ylim([0,17])
fontsize(16,"points")

figure, histogram(res.max_eig_arr(1:num_runs,2),10)
title('Norm of Hessian (minimizer)')
fontsize(16,"points")

figure, histogram(res.max_eig_arr(1:num_runs,3),10)
title('Norm of Hessian (SWA)')
fontsize(16,"points")
ylim([0,12])
ax=gca;
ax.XAxis.Exponent = 3;
...
figure, histogram(res.max_eig_arr(1:num_runs,4),10)
title('Norm of Hessian (SWA+Gaussian perturbation)')
ylim([0,11])
fontsize(16,"points")
%ylim([0.92,0.97])
